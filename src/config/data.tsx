...
export type PageData = {
  [key: string]: {
    ...
    subChapters?: Record<string, React.ReactElement | string>;
  };
};
...
Alles hatte wieder seine Ordnung. Maria las nun „Das goldene Blatt“, das sie am Morgen gekauft hatte, las über die Schwierigkeiten und Probleme in Königshäusern, deren Familienmitglieder ihr alle namentlich vertraut waren.`,
      "Ein Krimianfang": `Der Anfang eines Krimis zum selber Weiterschreiben
...
Was ist das Problem dieser Interpretationsarbeit?`}
        ...
        <br />
        <b>
          Die Erzählung „Der Kummer des Beamten Müller“ erschien im Erzählband:
        </b>
        <br />
        <b>
          <i>
            Die Sehnsucht fährt schwarz. Geschichten aus der Fremde, Stuttgart,
            dtv 1996
          </i>
        </b>
        <br />
