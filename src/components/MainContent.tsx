    ...
    Malerei: {
      ...
      description: [
        ...
        >
          <CardMedia
            component="img"
            image="/Malerei/Seestadt-Strand.jpg"
            sx={{
              // aspectRatio: "16 / 9",
              borderBottom: "1px solid",
              borderColor: "divider",
